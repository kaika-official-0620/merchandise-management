...
register_push_notifications(module.app, module)
...
try:
    from kaika_followup_patch_20260612 import apply as apply_followup_patch

    apply_followup_patch(module)
except Exception as patch_exc:
...
try:
    from proxy_service_integrity_patch_20260822 import apply as apply_proxy_service_integrity_patch

    apply_proxy_service_integrity_patch(module)
except Exception as patch_exc:
    print(f"[ERROR] proxy service integrity patch failed: {patch_exc}", flush=True)
    raise

app = module.app
from mobile_api import register_mobile_api

register_mobile_api(module)

from feature_plans import register_feature_plans
from feature_store_billing import register_store_billing
from self_inventory import register_self_inventory

register_feature_plans(module)
register_store_billing(module)
register_self_inventory(module)

from inventory_custody import register_inventory_custody
register_inventory_custody(module)
